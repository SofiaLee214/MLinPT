...
def parse_args():
    ...
    parser.add_argument('--training-data', '-i',
                        ...
                        dest='training_data',
                        help='Path to training data file (one password per line) (default: 68_linkedin_found_hash_plain.txt)')
...
# Enable eager execution for TF 2.x
...
# Use tf.compat.v1 for TF 1.x compatibility
